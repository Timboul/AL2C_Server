...
<html>
	...
	<div class="container">
            ...
            <h2>Introduction</h2>
            <p>
                Devant le développement des nouveaux outils de communication, il est nécessaire de porter une attention particulière à la 
                protection de la vie privée. C'est pourquoi, nous nous engageons à respecter la confidentialité des renseignements personnels que 
                nous collectons.
            </p>
            ...
            <p>
                Vos renseignements sont également collectés par le biais de l'interactivité pouvant s'établir entre vous et notre site Web et ce, de la
                façon suivante:
            </p>
            <p>Nous utilisons les renseignements ainsi collectés pour les finalités suivantes :</p>
            ...
            <p>
                ...
                Le droit d'opposition s'entend comme étant la possiblité offerte aux internautes de refuser que leurs renseignements personnels
                soient utilisées à certaines fins mentionnées lors de la collecte.
            </p>
            <p>
                Le droit de retrait s'entend comme étant la possiblité offerte aux internautes de demander à ce que leurs renseignements
            ...
            <p>
                ...
                <br />
                <br />
                Code postal : Palaprat, Toulouse 31000
                <br />
                Courriel : hananecherradi@yahoo.fr
                <br />
                Téléphone : 0699158935
            </p>
            <h2>Législation</h2>
            <p>
                Nous nous engageons à respecter les dispositions législatives énoncées dans :
                <br />
                Loi Informatique et Libertés et Politique de confidentialité de FACEBOOK
            </p>
	</div>
    </body>
</html>
